...
model {
  ...
  sigma_1[1] ~ normal(mu_std_alpha_1, std_std_alpha_1);
  sigma_1[2] ~ normal(mu_std_re_re_1, std_std_re_re_1);
  sigma_1[3] ~ normal(mu_std_re_pu_1, std_std_re_pu_1);
  sigma_1[4] ~ normal(mu_std_gobias_1, std_std_gobias_1);
  ...
  sigma_2[1] ~ normal(mu_std_alpha_2, std_std_alpha_2);
  sigma_2[2] ~ normal(mu_std_re_re_2, std_std_re_re_2);
  sigma_2[3] ~ normal(mu_std_re_pu_2, std_std_re_pu_2);
  sigma_2[4] ~ normal(mu_std_gobias_2, std_std_gobias_2);
